...
@bot.message_handler(commands=['buscar_cancún'])
...
@bot.message_handler(commands=['buscar_guadalajara'])
...
@bot.message_handler(commands=['buscar_cdmx'])
...
@bot.message_handler(commands=['buscar_mérida'])
...
@bot.message_handler(commands=['buscar_cdmx1'])
...
@bot.message_handler(commands=['buscar_los cabos'])
...
@bot.message_handler(commands=['buscar_cdmx2'])
...
@bot.message_handler(commands=['buscar_oaxaca'])
...
@bot.message_handler(commands=['buscar_cdmx3'])
...
@bot.message_handler(commands=['buscar_villa hermosa'])
...
@bot.message_handler(commands=['buscar_cdmx4'])
